...
func TestRenderXLSX_DerivesCountriesFromMethodLists(t *testing.T) {
	v := baseView()
	v.Countries = nil
	...
	if !strings.Contains(sheet, "US — United States; AR — Argentina") {
		t.Fatalf("missing merged countries in sheet:\n%s", sheet)
	}
}
